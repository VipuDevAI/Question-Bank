...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    ...
    const demoTests: Test[] = [
      { id: "test-1", tenantId: "tenant-demo", title: "Linear Equations Unit Test", type: "unit_test", subject: "Mathematics", grade: "10", chapterId: "chapter-1", duration: 30, totalMarks: 20, questionCount: 3, questionIds: ["q1", "q2", "q3"], isActive: true, resultsRevealed: false, createdBy: "user-teacher" },
      { id: "mock-1", tenantId: "tenant-demo", title: "Mathematics Mock Test 1", type: "mock", subject: "Mathematics", grade: "10", chapterId: null, duration: 90, totalMarks: 40, questionCount: 4, questionIds: ["q1", "q2", "q3", "q4"], isActive: true, resultsRevealed: false, createdBy: "user-teacher" },
      { id: "mock-2", tenantId: "tenant-demo", title: "Science Mock Test 1", type: "mock", subject: "Science", grade: "10", chapterId: null, duration: 45, totalMarks: 30, questionCount: 1, questionIds: ["q5"], isActive: true, resultsRevealed: false, createdBy: "user-teacher" },
    ];
  ...
  async getAnalytics(tenantId: string): Promise<{
    ...
    const completedAttempts = allAttempts.filter(a => a.status === "marked" || a.status === "submitted");
